...
function CreateDivDetailReservasi() {
    ...
    $(".tabscontent").append("<div id='DivDetailReservasi'>" +
                            "<label class='headerContent'>Laporan Detail Reservasi</label><br /><br />" +
...
function FindDetailReservation() {
    ...
    $.ajax({
        type: "POST",
        url: "/viona/Application/admin/SearchDetailReservation.php",
        data: {"status": status, "dari": dari, "sampai": sampai},
        dataType: "json",
...
function CreateTableDetailReservation() {
    ...
    $(".container-adminpage").append("<div id='DivTableDetailPenjualan'>" +
                                     ...
                                     "<th class='tanggal'>No Reservasi</th>" +
                                     "<th class='noTransaksi'>Nama Pelanggan</th>" +
                                     "<th class='noTransaksi'>Tanggal Checkin</th>" +
                                     "<th class='noTransaksi'>Tanggal Checkout</th>" +
...
function InsertDetailReservationToTable(data) {
    ...
    $.each(data, function (item) {
        ...
        $("#TableDetailPenjualan tbody").append("<tr onclick='ShowDetailProduct(\"" + data[item].noreservation + "\")'>" +
                                                "<td class='tanggal'>" + data[item].noreservation + "</td>" +
                                                "<td class='noTransaksi'>" + data[item].customer + "</td>" +
                                                "<td class='noTransaksi'>" + data[item].checkin.toDefaultFormatDate() + "</td>" +
                                                "<td class='noTransaksi'>" + data[item].checkout.toDefaultFormatDate() + "</td>" +
