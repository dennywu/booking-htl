...
function FindDetailReservationPerHari() {
    ...
    $.ajax({
        type: "POST",
        url: "/viona/Application/admin/SearchDetailReservationPerHari.php",
...
function InsertDetailReservationPerHariToTable(data) {
    ...
    $.each(data, function (item) {
        ...
        $("#TableDetailPenjualan tbody").append("<tr onclick='ShowDetailProduct(\"" + data[item].transactiondate + "\")'>" +
                                                "<td class='tanggal'>" + data[item].reservationdate.toDefaultFormatDate() + "</td>" +
                                                "<td class='tanggal'>" + data[item].total + "</td>" +
                                                "</tr>");
    });
